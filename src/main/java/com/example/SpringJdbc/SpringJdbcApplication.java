...
import com.example.SpringJdbc.MasinaRepository;
		...
		do{
			...
			switch (opt)
			{
				case 0:
					...
					break;
				case 1:
					System.out.println("Nr randurilor afectate de inserare: " + repo.insert(new Masina("CS15CMI", "Logan", 2005, "verde", 19000)));
					break;
				case 2:
					System.out.print("Nr_inmatriculare: ");
					String nr_inmatriculare = scanner.nextLine();
					System.out.print("Nr randurilor afectate: " + repo.deleteByNr_inmatriculare(nr_inmatriculare));
					break;
				case 3:
					System.out.print("Nr_inmatriculare: ");
				...
				case 5:
					...
					break;
				case 6:
					System.out.println("Nr masini: " + repo.countByNr_kilometrii_smallerThan(100000));
					break;
				case 7:
